    ...
    namespace BrainStem {
        ...
        public:
            ...
            typedef std::function<
                aErr(const aPacket* packet, void* pRef)
            > streamCallback_t;
            ...
            /// \param option option to filter by (supports Wildcards)
            /// \param index index to filter by (supports Wildcards)
            /// \param status map of key value pairs to be filled based on the parameters.
            /// Link::getStreamKeyElement should be used to decode the keys
            /// \return aErrParam if status is null
            /// \return aErrNone - success
            ...
            /// \return ::aErrPacket - Not a stream packet
            /// \return ::aErrUnknown - Unknown decoding issue.
            /// \return ::aErrNone - success.
        ...
        public:
            ...
            /// \param sequence - Sequence byte to be checked.
            ...
            /// \param status map of option value pairs to be filled.
            /// Option codes are based on the cmd and index of the calling API.
            /// \return aErrParam if status is null
